...
public class AnalogniSatAp extends Applet implements Runnable {
	...
	*/
	...
	// start metoda koja pokreæe thread
	public void start() {
	...
	// sve dok je aktivan trenutni thread vršit æe se promjene pomoæu repaint()
	public void run() {
	...
	// metoda koja vrši osvježavanje sadržaja appleta
	public void paint(Graphics g) {

		// inicijaliziranje nove taèke koja sadrži koordinate x i y
		tacka = new Point();
		// pronalaženje lokalnog vremena koje æe se koristiti za pozicioniranje kazaljki
		LocalTime lokalno = LocalTime.now();
		// niz selekcija koje filtiraju kvadrante te na osnovu toga pomoæu metoda za
...
// iscrtavanje okvira sata te njegovih vremenskih podjela
		...
		/*
		 * na osnovu point tipa i vrijednosti koje su metode vratile iscrtava se položaj
		 * vrha kazaljke koja oznaèava sekunde
		 */
		...
		// niz selekcija koje determiniraju položaj vrha kazaljke za minute
		...
		// iscrtavanje vrha kazaljke za minute (koja je nešto deblja od kazaljke za
		// sekunde)
		Graphics2D g2D = (Graphics2D) g;
		g2D.setStroke(new BasicStroke(2F));
		g2D.setColor(Color.GREEN);
		g2D.drawLine(200, 200, (int) tacka.getX(), (int) tacka.getY());
		// niz selekcija koje odreðuju položaj vrha kazaljke koja pokazuje sate
	...
	/*
	 * metoda koja vraæa koordinate vrha kazaljke u prvom kvadrantu,namjenjena za
	 * odreðivanje položaja kazalji za minute i sekunde ali može odreðivati i
	 * položaj kazaljke za sate uz proslijeðenu odgovarajuæu vrijednost
	 */
	...
	/*
	 * metoda koja vraæa koordinate vrha kazaljke u drugom kvadrantu,namjenjena za
	 * odreðivanje položaja kazalji za minute i sekunde ali može odreðivati i
	 * položaj kazaljke za sate uz proslijeðenu odgovarajuæu vrijednost
	 */
	...
	/*
	 * metoda koja vraæa koordinate vrha kazaljke u treæem kvadrantu,namjenjena za
	 * odreðivanje položaja kazalji za minute i sekunde ali može odreðivati i
	 * položaj kazaljke za sate uz proslijeðenu odgovarajuæu vrijednost
	 */
	...
	/*
	 * metoda koja vraæa koordinate vrha kazaljke u èetvrtom kvadrantu,namjenjena za
	 * odreðivanje položaja kazalji za minute i sekunde ali može odreðivati i
	 * položaj kazaljke za sate uz proslijeðenu odgovarajuæu vrijednost
	 */
